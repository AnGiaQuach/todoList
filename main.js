...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   newToDoFromUser: () => (/* binding */ newToDoFromUser)\n/* harmony export */ });\n/* harmony import */ var _operate_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./operate.js */ \"./src/operate.js\");\n\n\nfunction newToDoFromUser(section, mainBox) {\n  const newTaskBtn = document.querySelector(\".new-task-icon\");\n  const newTaskBox = document.querySelector(\".new-task-box\");\n  const titleInput = document.querySelector(\"#title\");\n  const description = document.querySelector(\"#description\");\n\n  const saveBtn = document.querySelector(\"#save\");\n  newTaskBtn.addEventListener(\"click\", () => {\n    newTaskBox.classList.toggle(\"vanish\");\n  });\n  saveBtn.addEventListener(\"click\", () => {\n    event.preventDefault();\n    const id = self.crypto.randomUUID();\n    const todoData = {\n      id: id,\n      title: titleInput.value,\n      desc: description.value,\n    };\n    let todoList = (0,_operate_js__WEBPACK_IMPORTED_MODULE_0__.getDataFromDB)(\"inbox\");\n    todoList.push(todoData);\n    (0,_operate_js__WEBPACK_IMPORTED_MODULE_0__.sendDataToDB)(\"inbox\", todoList);\n    mainBox.appendChild((0,_operate_js__WEBPACK_IMPORTED_MODULE_0__.createToDoCard)(todoData, section, mainBox));\n\n    newTaskBox.classList.toggle(\"vanish\");\n  });\n}\n\n\n\n\n//# sourceURL=webpack://todolist/./src/form.js?");
